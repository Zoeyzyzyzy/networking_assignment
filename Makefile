...
server_c_udp: udp_server.c 
	$(CC) $(ARGS) -o server_c_udp udp_server.c

client_c_udp: udp_client.c
	$(CC) $(ARGS) -o client_c_udp udp_client.c

server_c_tcp: tcp_server.c
	$(CC) $(ARGS) -o server_c_tcp tcp_server.c

client_c_tcp: tcp_client.c
	$(CC) $(ARGS) -o client_c_tcp tcp_client.c
